 ...
 */
package org.etools.j1939tools.engine.simulated;
...
public class Engine implements AutoCloseable {
    ...
    public Engine(Bus bus) throws BusException {
        ...
        sim.schedule(50,
                ...
                () -> {
                    if (!isKeyOn()) {
                        // Rather then stopping the schedule, just send a
                        // different message
        ...
        // BCT PGN 65251 from Engine #1 (0) with SPNs 539, 540, 541, 542, 543,
        // 544
        // @formatter:off
        sim.schedule(5000,
                     MILLISECONDS,
