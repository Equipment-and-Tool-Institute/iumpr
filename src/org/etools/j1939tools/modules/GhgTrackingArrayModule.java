...
public class GhgTrackingArrayModule {
    ...
    private String printXevTrackingArray(List<GenericPacket> packets) {
        ...
        String[][] table = {
                ...
                { "| Prod: Prop system active,  min |", "SPN_12791", "SPN_12794", "SPN_12797" },
                { "| Prod: Prop idle active,    min |", "SPN_12792", "SPN_12795", "SPN_12798" },
                { "| Prod: Prop urban active,   min |", "SPN_12793", "SPN_12796", "SPN_12799" },
                { "|--------------------------------+", "-------------+", "-------------+", "-------------|" },
        };
    ...
    private String printTrackingArray(List<GenericPacket> packets) {
        ...
        String[][] table = {
                ...
                {"|                         |", "   100 Hour  |", "   100 Hour  |", "   Lifetime  |"},
                {"|-------------------------+", "-------------+", "-------------+", "-------------|"},
                {"| Engine Run Time, min    |", "SPN_12700", "SPN_12715", "SPN_12730"},
                ...
                {"| Urban Speed Run Time,min|", "SPN_12706", "SPN_12721", "SPN_12736"},
                {"| Idle Run Time, min      |", "SPN_12707", "SPN_12722", "SPN_12737"},
                {"| Engine Idle Fuel, l     |", "SPN_12708", "SPN_12723", "SPN_12738"},
                {"| PTO Run Time, min       |", "SPN_12709", "SPN_12724", "SPN_12739"},
                {"| PTO Fuel Consumption, l |", "SPN_12710", "SPN_12725", "SPN_12740"},
                {"| AES Shutdown Count      |", "SPN_12711", "SPN_12726", "SPN_12741"},
                {"| Stop-Start Run Time, min|", "SPN_12712", "SPN_12727", "SPN_12742"},
                {"|-------------------------+", "-------------+", "-------------+", "-------------|"},
        };
